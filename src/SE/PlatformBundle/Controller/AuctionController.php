  ...
  private $state;
    ...
    if ($this->getUser() === $advert->getUser()) {
          ...
          if ($auctionAccept !== null && $user !== null){
              ...
              $session->getFlashBag()->add('addSuccess',"Vous avez bien accepté l'offre à ".$auctionAccept->getValue()." €, il vous reste à contacter l'artisan pour convenir d'un rendez-vous");
