 ...
 * @ORM\Entity(repositoryClass="SE\AuctionBundle\Repository\CommentRepository")
 */
class Comment
{
    /**
     ...
     * Set sender
     *
     * @param \SE\UserBundle\Entity\User $sender
     *
     * @return Comment
     */
    public function setSender(\SE\UserBundle\Entity\User $sender)
    {
        $this->sender = $sender;
     ...
     * Set receiver
     *
     * @param \SE\UserBundle\Entity\User $receiver
     *
     * @return Comment
     */
    public function setReceiver(\SE\UserBundle\Entity\User $receiver)
    {
