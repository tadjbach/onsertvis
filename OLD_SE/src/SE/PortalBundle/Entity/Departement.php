 ...
 * @ORM\Entity(repositoryClass="SE\PortalBundle\Repository\DepartementRepository")
 */
class Departement
{
     /**
     * @ORM\ManyToOne(targetEntity="SE\PortalBundle\Entity\Region")
     * @Assert\Valid()
     */
   ...
   /**
     ...
     * Set region
     *
     * @param \SE\PortalBundle\Entity\Region $region
     *
     * @return Departement
     */
    public function setRegion(\SE\PortalBundle\Entity\Region $region = null)
    {
        $this->region = $region;
     ...
     * Get region
     *
     * @return \SE\PortalBundle\Entity\Region
     */
