...
il Team.
',
    'resetting.check_email' => 'Un\'email è stata inviata a %email%. Contiene il link d\'attivazione che devi utilizzare per il reset della password.
Nota: E\' possibile richiedere una password entro %tokenLifetime% ore.
