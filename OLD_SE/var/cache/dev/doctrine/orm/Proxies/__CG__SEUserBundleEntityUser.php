...
namespace Proxies\__CG__\SE\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \SE\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'accountType', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'civility', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'postalCode', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'cpCity', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'payment', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'societyType', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'dateCreation', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'dateUpdate', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'detail', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'isAcountComplete', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'phoneNumber', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'isNewsLetter', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'categories', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'calendar', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'siret', '' . "\0" . 'SE\\UserBundle\\Entity\\User' . "\0" . 'rate', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setIsNewsLetter($isNewsLetter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsNewsLetter', [$isNewsLetter]);
    ...
    public function getIsNewsLetter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsNewsLetter', []);
    ...
    public function setIsAcountComplete($isAcountComplete)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsAcountComplete', [$isAcountComplete]);

        return parent::setIsAcountComplete($isAcountComplete);
    }
    ...
    public function getIsAcountComplete()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsAcountComplete', []);

        return parent::getIsAcountComplete();
    }
    ...
    public function setSocietyType(\SE\UserBundle\Entity\SocietyType $societyType = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSocietyType', [$societyType]);

        return parent::setSocietyType($societyType);
    }
    ...
    public function getSocietyType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSocietyType', []);

        return parent::getSocietyType();
    }
    ...
    public function setCpCity($cpCity)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCpCity', [$cpCity]);

        return parent::setCpCity($cpCity);
    }
    ...
    public function getCpCity()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCpCity', []);

        return parent::getCpCity();
    }
